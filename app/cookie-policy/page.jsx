...
export default function CookiePolicy() {
    const { data: pageData, loading } = useGetService(
        "/pages/16?depth=2&draft=false&locale=undefined&trash=false"
    );
    ...
    const sectionSevenData = layoutData[6] || {};
    const sectionEightData = layoutData[7] || {};
    const sectionNineData = layoutData[8] || {};
    const sectionTenData = layoutData[9] || {};
    const sectionElevenData = layoutData[10] || {};
    const sectiontweleveData = layoutData[11] || {};
    ...
    const sectionSeven = extractSectionData(sectionSevenData, {});
    const sectionEight = extractSectionData(sectionEightData, {});
    const sectionNine = extractSectionData(sectionNineData, {});
    const sectionTen = extractSectionData(sectionTenData, {});
    const sectionEleven = extractSectionData(sectionElevenData, {});
    const sectiontweleve = extractSectionData(sectiontweleveData, {});
                    ...
                    <div className="space-y-8 text-gray-300">
                        ...
                        <div className="bg-[#111]/60 backdrop-blur-2xl border border-white/10 p-6 sm:p-8 rounded-2xl">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>{sectionSeven?.description3}</li>
                                <li>{sectionSeven?.description4}</li>
                            </ul>
                            <br />
