...
export default function PrivacyPolicy() {
    const { data: pageData, loading } = useGetService(
        "/pages/12?depth=2&draft=false&locale=undefined&trash=false"
    );
    ...
    console.log("1111111111 ", sectionOneData.columns);
    //   console.log("22222222 ",sectionOneData?.columns[0]);
                    ...
                    <div className="space-y-8 text-gray-300">
                        ...
                        <div className="bg-[#111]/60 backdrop-blur-2xl border border-white/10 p-6 sm:p-8 rounded-2xl">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>{sectionThree?.description6}</li>
                            </ul>
                        </div>
