        ...
        >
          ...
          >
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 bg-gradient-to-br from-pink-500/20 to-purple-500/20 rounded-full blur-3xl"
                animate={isInView ? { scale: [1, 1.1, 1] } : { scale: 1 }}
                transition={{ duration: 3, repeat: Number.POSITIVE_INFINITY }}
              />

              {/* Number */}
              <div className="relative text-9xl md:text-[200px] font-bold text-transparent bg-clip-text bg-gradient-to-br from-pink-400 via-purple-400 to-pink-400 drop-shadow-2xl">
                {section.number}
              </div>
            </motion.div>
          </motion.div>
